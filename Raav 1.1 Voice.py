...
def memoryStorageReadValues(questionAsked):
	filepath = "Memory.raavmemory"
	with open(filepath) as fp:
		line = fp.readline()
		count = 1
		while line:
			questionsAsked.append(line.strip())
			line = fp.readline()
			count += 1
...
def memoryStorageWrite(addMEM, MEMquestion):
	...
	fileMEM = open("Memory.raavmemory", "a")
	fileMEM.write(">>>" + addMEM)
	fileMEM.write("\n")
	fileMEM.close()
	fileQST = open("Question.raavmemory", "a")
